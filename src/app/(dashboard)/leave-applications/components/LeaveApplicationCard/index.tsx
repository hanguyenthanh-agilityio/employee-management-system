...
const LeaveCard = ({ title, days, onClick }: LeaveCardProps) => {
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="bg-white text-[#253D90] text-[70px] w-[135px] h-[135px] rounded-full flex items-center justify-center">
        {days}
      </div>
      <div className="flex flex-col justify-center pl-10">
        <div className="text-center font-medium text-[25px] pb-2 w-[200px] overflow-hidden text-ellipsis whitespace-nowrap">
          {title}
        </div>
        <Button
          variant="secondary"
