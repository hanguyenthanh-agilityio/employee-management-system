    ...
    <main className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
      ...
      <div className="relative w-full h-[60vh] md:h-full">
        ...
        <div className="relative z-20 py-6 px-6 sm:px-10 text-white h-full flex flex-col justify-center">
          ...
          />
          <div>
            <h2 className="text-2xl md:text-[50px] font-bold leading-tight">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="text-lg md:text-[25px] bg-yellow-400 text-black font-bold px-6 md:px-10 py-2 md:py-4 rounded-[8px] md:rounded-[11px]">
                Learn More
              </button>
              <button className="text-lg md:text-[25px] font-bold border-2 md:border-4 border-white px-6 md:px-10 py-2 md:py-4 rounded-[8px] md:rounded-[11px] hover:bg-white/10">
                Our Features
              </button>
            </div>
          </div>
